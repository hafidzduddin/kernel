...
static void raid6_int16_gen_syndrome(int disks, size_t bytes, void **ptrs)
{
	u8 **dptr = (u8 **)ptrs;
	u8 *p, *q;
	int d, z, z0;
...
const struct raid6_calls raid6_intx16 = {
	raid6_int16_gen_syndrome,
	NULL,		/* always valid */
	"int" NSTRING "x16",
	0
};
